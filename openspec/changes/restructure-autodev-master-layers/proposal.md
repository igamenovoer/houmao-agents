...
- Keep `skillset/imsight-skills/imsight-autodev-master/SKILL.md` as a compact entrypoint and router rather than the home for detailed command semantics.
...
- Updates `skillset/imsight-skills/imsight-autodev-master/` structure and documentation.
