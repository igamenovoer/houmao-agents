...
- Target path: `<repo-root>/.imsight-arts/worktrees/worktree-<ts>`
...
- `<skill-dir>/scripts/create_worktree.sh`: Create the worktree and add the safe symlinks.

## Example Prompts

- `Use $imsight-dev-project-mgr create-worktree to create a clean worktree for this repo and link the agent home directories.`
- `Use $imsight-dev-project-mgr create-worktree to make a clean worktree of branch release/1.4 and reuse .claude and .pixi.`
- `Use $imsight-dev-project-mgr create-worktree at /tmp/gig-agents-clean; keep my current uncommitted changes untouched.`
