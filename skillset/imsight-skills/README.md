...
- [`imsight-agent-skill-handling`](imsight-agent-skill-handling/SKILL.md): Manual-only agent skill handling workflow that analyzes skill logic into reports and formats target skills to the bundled Imsight skill style guide.
