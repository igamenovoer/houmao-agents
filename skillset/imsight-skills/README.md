...
- [`imsight-project-automation`](imsight-project-automation/SKILL.md): Run maintained one-pass project automation routines, including the OpenSpec explore, propose, apply, sync, and archive lifecycle.
- [`imsight-project-design`](imsight-project-design/SKILL.md): Stage feature planning through scaffolding, feature definition, use-case design, interface or skill design, and compact implementation handoffs.
