...
- [x] 1.1 Add `init-slave-for-openspec` to `skillset/imsight-skills/imsight-autodev-master/SKILL.md` operations and routing.
- [x] 1.2 Add `skillset/imsight-skills/imsight-autodev-master/subskills/init-slave-for-openspec.md`.
...
- [x] 2.1 Add `init-openspec` to `skillset/imsight-skills/imsight-autodev-slave/SKILL.md` operations and routing.
- [x] 2.2 Add `skillset/imsight-skills/imsight-autodev-slave/subskills/init-openspec.md`.
