# Imsight Project Management Specification

## Purpose

Define the invocation, command organization, project-foundation behavior, isolated project-development behavior, artifact ownership, and migration contract for the Imsight project manager skill.
