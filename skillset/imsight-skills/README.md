...
- [`imsight-agent-skill-handling`](imsight-agent-skill-handling/SKILL.md): Manual-only agent skill handling workflow that analyzes skill logic into reports, designs new skills from user tasks, creates new skills from user requests, and formats target skills to the bundled Imsight skill style guide.
